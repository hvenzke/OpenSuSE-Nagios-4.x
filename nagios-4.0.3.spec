...
Source12:       %{name}-%{version}-docs.tar.bz2
...
for file in "README sample-config/README sample-config/template-object/README"; do
       chmod 644 $RPM_BUILD_DIR/%{name}-%{version}/$file
done
...
%doc Changelog LEGAL LICENSE README INSTALLING UPGRADING config.log doxy.conf sample-config/
%dir %{nagios_libdir}
...
- package for v 4.0.3
- updated nagios docs from http://nagios.sourceforge.net/docs/nagioscore/4/en/ to v4.0.3
* Wed Jan 22 2014 obs@botter.cc
- package for v 3.5.1
