...
Source19:       pkg-nagios-plugins-contrib-master.tar.bz2
Source20:       contrib-misc-tarball-1.4.19.tar.gz
...
%{__mkdir} -m 0755   $RPM_BUILD_ROOT/etc
%{__mkdir} -m 0755   $RPM_BUILD_ROOT/etc/nagios
%{__mkdir} -m 0755   $RPM_BUILD_ROOT/var
...
%{__install} -m 0755 contrib/misc/check_radius.pl %{buildroot}/%{nagios_plugindir}/check_radius
...
%{__mkdir} -m 0755 %{buildroot}/etc/nagios/contrib
...
%{__install} -m 0755 contrib/check_haproxy/haproxy.cfg /%{buildroot}/etc/nagios/contrib/check_haproxy
%{__install} -m 0755 contrib/check_smstools/README.check_smstools /%{buildroot}/etc/nagios/contrib/README.check_smstools
...
%changelog
*  Wed Mar 13 2014 support@remsnet.de
- added managed contribs from https://github.com/bzed/pkg-nagios-plugins-contrib as $BUILD/contrib
- RE-added unmaged contrib from oss-12.3 nagios-plugins 1.4.19 $BUILD/contrib/misc
...
* Fri Feb 22 2013 lars@linux-schulserver.de
  pkg for oss 12.1 - oss 12.3
